...
/* NTSC FIR filter coefficients.  These were generated by a tool called
 * "firfilt.c" found on the web.  Low-pass filter, fs=28MHz, cutoff=4.2MHz,
 * rectangular window, M=3. */
