...
typedef DELEGATE_S2(void, unsigned, uint32_t) DELEGATE_T2(void, unsigned, uint32);
...
typedef DELEGATE_S1(bool, int) DELEGATE_T1(bool, int);
...
typedef DELEGATE_S3(int, int, unsigned, uint8_t *) DELEGATE_T3(int, int, unsigned, uint8p);
typedef DELEGATE_S3(int, int, unsigned, const uint8_t *) DELEGATE_T3(int, int, unsigned, cuint8p);
...
DELEGATE_DEF_PROTO2(void, void, unsigned, unsigned, uint32_t, uint32);
...
DELEGATE_DEF_PROTO1(bool, bool, int, int);
...
DELEGATE_DEF_PROTO1(uint32_t, uint32, int, int);
...
#define DELEGATE_SAFE_CALLN(d,...) do { if ((d).func) { DELEGATE_CALLN(d,__VA_ARGS__); } } while (0)

#define DELEGATE_GET_CALL(_1,_2,_3,_4,_5,_6,_7,NAME,...) NAME

#define DELEGATE_CALL(...) DELEGATE_GET_CALL(__VA_ARGS__, DELEGATE_CALLN, DELEGATE_CALLN, DELEGATE_CALLN, DELEGATE_CALLN, DELEGATE_CALLN, DELEGATE_CALLN, DELEGATE_CALL0, DELEGATE_DUMMY_VALUE)(__VA_ARGS__)
#define DELEGATE_SAFE_CALL(...) DELEGATE_GET_CALL(__VA_ARGS__, DELEGATE_SAFE_CALLN, DELEGATE_SAFE_CALLN, DELEGATE_SAFE_CALLN, DELEGATE_SAFE_CALLN, DELEGATE_SAFE_CALLN, DELEGATE_SAFE_CALLN, DELEGATE_SAFE_CALL0, DELEGATE_DUMMY_VALUE)(__VA_ARGS__)
