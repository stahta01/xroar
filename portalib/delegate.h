...
typedef DELEGATE_S3(uint8_t, _Bool, uint16_t, uint8_t) DELEGATE_T3(uint8, bool, uint16, uint8);
...
DELEGATE_DEF_PROTO3(uint8_t, uint8, _Bool, bool, uint16_t, uint16, uint8_t, uint8);
